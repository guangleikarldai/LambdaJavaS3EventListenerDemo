package com.amazonaws.lambda.demo.s3.demo;
...
public class LambdaS3EventHandlerTest {
    ...
    @Test
    public void testLambdaS3EventHandler() {
        LambdaS3EventHandler handler = new LambdaS3EventHandler(s3Client);
